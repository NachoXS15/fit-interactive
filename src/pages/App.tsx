...
export default function App() {
  return (
    ...
    >
      ...
      <NavLink to="https://fit-puzzle.netlify.app" className="w-1/4 h-52 active:scale-110 transition flex items-center justify-center text-3xl rounded-3xl bg-orange-lr">
        <h2>ROMPECABEZAS</h2>
      </NavLink>
