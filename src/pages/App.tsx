...
export default function App() {
  return (
    <div
      className="w-full min-h-screen px-10 pt-32 bg-cover bg-center bg-no-repeat flex items-center justify-center gap-10"
      style={{ backgroundImage: 'url("/assets/bg_inicio.jpg")' }}
    >
