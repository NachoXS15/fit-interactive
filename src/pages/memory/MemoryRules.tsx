...
export default function MemoryRules() {
    return (
        <div className='w-full relative px-48 h-screen bg-cover bg-center flex flex-col justify-around py-10 items-start' style={{ backgroundImage: `url('/assets/memory_bg.webp')`, fontFamily: 'franklin-gothic-atf, sans-serif;' }}>
            <NavLink to="/" className="absolute top-24 right-44"><CloseIcon /></NavLink>
